...
৩) **Build and deployment** এ গিয়ে **Source** হিসেবে **GitHub Actions** বা **Deploy from a branch** বেছে নিন।  
৪) যদি **Deploy from a branch** ব্যবহার করেন, তাহলে `main` ব্রাঞ্চ এবং `/` রুট সিলেক্ট করুন।  
৫) কাস্টম ডোমেইন থাকলে `CNAME` ফাইলে আপনার ডোমেইন রাখুন (এখানে already আছে)।  

Astro প্রোজেক্টের জন্য GitHub Actions দিয়ে auto-build সেট করা সবচেয়ে ভালো। অফিসিয়াল গাইড:  
